...
//express router
const dishRouter = require('./routes/dishRouter');   //this is to include router made i different file
const bodyParser = require('body-parser');     // body parsing middleware. Parse incoming request bodies in a
                                                // middleware before your handlers, available under the req.body property 
const morgan = require('morgan');
const express = require('express'),
...
app.use('/dishes', dishRouter);           ///this is use dishrouter when dihes is requested
